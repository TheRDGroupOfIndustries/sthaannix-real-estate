    ...
    <tbody className="divide-y divide-gray-100">
      {pendingAds.map((ad, idx) => (
        ...
        >
          ...
          <td className="px-6 py-4">
            {ad.property?.location?.city}, {ad.property?.location?.state}
          </td>
          <td className="px-6 py-4">
          ...
          <td className="px-6 py-4">{ad.property?.bhk || "-"}</td>
          <td className="px-6 py-4">{ad.property?.bathroom || "-"}</td>
          <td className="px-6 py-4">
            {ad.platform?.join(", ") || "-"}
          </td>
