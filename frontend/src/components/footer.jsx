...
const contactInfo = [
  ...
  { 
    icon: Mail, 
    text: 'support@Sthaanix.com',
    href: 'mailto:support@Sthaanix.com' 
  },
];
          ...
          >
            <div className="flex items-center justify-center lg:justify-start mb-6">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500 font-medium"> Real Estate</p>
              </div>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <motion.p 
              ...
              transition={{ duration: 0.5 }}
            >
              <span>© {new Date().getFullYear()} Sthaanix. All Rights Reserved.</span>
