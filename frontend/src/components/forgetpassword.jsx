      ...
      >
        ...
        >
          ...
          <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl m-[2px] p-8">
              ...
              <div className="text-center mb-8">
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    No worries, we&apos;ll send you reset instructions to get
                    you back on track.
                  </p>
                </motion.div>
              </div>
            ...
            {!isSuccess && (
              <motion.form
                onSubmit={resetClick ? handleSubmitOtp : handleSubmit}
                className="space-y-6"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                <div>
                  ...
                  <div className="relative group">
                    <div
                      className={`absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm ${
                ...
                {resetClick && (
                  <div>
                    ...
                    <div className="relative group">
                      <div
                        className={`absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm ${
                          otpFocused ? "opacity-100" : ""
                        }`}
                      ></div>
                      <div className="relative">
                        <Mail
                          className={`absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 transition-colors duration-300 ${
                            otpFocused ? "text-blue-600" : "text-gray-400"
                          }`}
                        />
                        <input
                          type="otp"
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 flex items-center justify-center space-x-2 font-medium"
                  >
                    <span>Submit</span>
                  </motion.button>
                </div>
